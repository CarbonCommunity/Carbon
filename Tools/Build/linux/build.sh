...
if [[ "${TARGET}" == *"Unix"* ]]; then
	...
	mkdir -p "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed"
	mkdir -p "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed/x64"
	mkdir -p "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed/x86"
	cp "${ROOT}/Release/.tmp/${TARGET}/carbon/managed/lib/MySql.Data.dll" "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed/MySql.Data.dll"
	cp "${ROOT}/Release/.tmp/${TARGET}/carbon/managed/lib/System.Data.SQLite.dll" "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed/System.Data.SQLite.dll"
	cp -a "${ROOT}/Tools/SQLRedist/x64/." "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed/x64/"
	cp -a "${ROOT}/Tools/SQLRedist/x86/." "${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/Managed/x86/"
else
