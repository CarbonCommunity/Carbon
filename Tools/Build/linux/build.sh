...
if [[ "${TARGET}" == *"Unix"* ]]; then
	...
	cp "${ROOT}/Carbon.Core/Carbon.Native/target/x86_64-unknown-linux-gnu/release/libCarbonNative.so" 	"${ROOT}/Release/.tmp/${TARGET}/RustDedicated_Data/libCarbonNative.so"
else
