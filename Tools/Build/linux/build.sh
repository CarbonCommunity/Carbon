...
if [[ "${TARGET}" == *"Unix"* ]]; then
	...
	mono "${ROOT}/Tools/BuildInfo/Carbon.BuildInfo.exe" -carbon "${ROOT}/Release/.tmp/${TARGET}/carbon/managed/Carbon" -o "${ROOT}/Release/build-unix.info"
else
	...
	mono "${ROOT}/Tools/BuildInfo/Carbon.BuildInfo.exe" -carbon "${ROOT}/Release/.tmp/${TARGET}/carbon/managed/Carbon" -o "${ROOT}/Release/build.info"
fi
