...
## Similarities
You'll quickly become familiar with the folder structure. Instead of **root/oxide/config** or **root/oxide/plugins** you now have **root/carbon/plugins**, etc. In the plugins folder, you must add your DLLs and/or CS files. This might change in the future to organize and split the two types - and yes, both DLLs and script files will be supported.
...
You may already do so, but it is a chore. My goal is to try and minimize modifying your original Oxide plugins to fit working with Carbon.
* OnPluginLoaded
* OnServerSave
