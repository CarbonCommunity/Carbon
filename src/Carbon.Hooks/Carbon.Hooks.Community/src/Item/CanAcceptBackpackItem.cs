...
public partial class Category_Fun
{
	...
	{
		[HookAttribute.Patch("CanAcceptBackpackItem", "CanAcceptBackpackItem", typeof(ItemModBackpack), "CanAcceptItem", new System.Type[] { typeof(BasePlayer), typeof(Item), typeof(Item), typeof(int) })]
