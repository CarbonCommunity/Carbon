...
public class Player : Library
{
	...
	public void Rename(BasePlayer player, string name) => player.Rename(name);

	internal static void RefreshForOtherClients(BasePlayer player) => PlayerEx.RefreshForOtherClients(player);
