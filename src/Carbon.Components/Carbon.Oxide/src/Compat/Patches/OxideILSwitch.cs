...
using ElementType = AsmResolver.PE.DotNet.Metadata.Tables.Rows.ElementType;
            ...
            foreach (MethodDefinition method in type.Methods)
            {
                ...
                for (int index = 0; index < body.Instructions.Count; index++)
                {
                    ...
                    if (CIL.OpCode == CilOpCodes.Callvirt &&
                        ...
                        btw.FullName == "Carbon.Plugins.CommandLibrary" &&
                    ...
                    if (CIL.OpCode == CilOpCodes.Callvirt &&
                        ...
                        ctw.FullName == "Carbon.Plugins.CommandLibrary" &&
