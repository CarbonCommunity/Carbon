...
{    /* 
    ...
    {
        [HarmonyPrefix]
        static bool Prefix () { try { return main.codebase.InitializeHook (); } catch { } return true; }
    }
    ...
    {
        [HarmonyPrefix]
        static bool Prefix ( BasePlayer __instance ) { try { return main.codebase.RespawnHook ( __instance ); } catch { return true; } }
    }
    ...
    internal class Chat_sayAs
    {
        ...
        {
            try { return main.codebase.sayAsHook ( player, message, targetChannel ); } catch { return true; }
        }
    }
    */
}
