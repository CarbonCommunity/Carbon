...
public static class HookCaller
{
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallHook<T>(T plugin, string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8}, object {arg9}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallDeprecatedHook<T>(T plugin, string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8}, object {arg9}) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticHook(string {hookName}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8}, object {arg9})", 4);
	...
	{
		Carbon.Logger.Debug($"public static object CallStaticDeprecatedHook(string {oldHook}, string {newHook}, DateTime {expireDate}, object {arg1}, object {arg2}, object {arg3}, object {arg4}, object {arg5}, object {arg6}, object {arg7}, object {arg8}, object {arg9})", 4);
	...
	{
		Carbon.Logger.Debug($"private static object CallPublicHook<T>(this T plugin, string {hookName}, object[] args) where T : BaseHookable", 4);
	...
	{
		Carbon.Logger.Debug($"private static object CallPublicStaticHook(string {hookName}, object[] args)", 4);
