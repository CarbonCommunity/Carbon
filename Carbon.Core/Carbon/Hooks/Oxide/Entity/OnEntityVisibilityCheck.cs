...
namespace Carbon.Extended
{
    ...
    [OxideHook.Patch ( typeof ( BaseEntity.RPC_Server.IsVisible ), "Test", Parameters = new Type [] { typeof ( uint ), typeof ( string ), typeof ( BaseEntity ), typeof ( BasePlayer ), typeof ( float ) } )]
